...
Tag _tagDeserialize(
  ...
  object.rawColor = reader.readStringOrNull(offsets[1]);
  return object;
}
...
extension TagQueryWhere on QueryBuilder<Tag, Tag, QWhereClause> {
  ...
  QueryBuilder<Tag, Tag, QAfterWhereClause> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterWhereClause> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQueryFilter on QueryBuilder<Tag, Tag, QFilterCondition> {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'rawColor',
      ));
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'rawColor',
      ));
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'rawColor',
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'rawColor',
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'rawColor',
        value: '',
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> rawColorIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'rawColor',
        value: '',
...
extension TagQuerySortBy on QueryBuilder<Tag, Tag, QSortBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> sortByRawColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rawColor', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> sortByRawColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rawColor', Sort.desc);
    });
  }
}
...
extension TagQuerySortThenBy on QueryBuilder<Tag, Tag, QSortThenBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> thenByRawColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rawColor', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> thenByRawColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rawColor', Sort.desc);
    });
  }
...
extension TagQueryWhereDistinct on QueryBuilder<Tag, Tag, QDistinct> {
  ...
  QueryBuilder<Tag, Tag, QDistinct> distinctByRawColor(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'rawColor', caseSensitive: caseSensitive);
    });
  }
}
...
extension TagQueryProperty on QueryBuilder<Tag, Tag, QQueryProperty> {
  ...
  QueryBuilder<Tag, String?, QQueryOperations> rawColorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'rawColor');
    });
  }
}
